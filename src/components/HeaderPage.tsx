...
function HeaderPage() {
  return (
    <div
      className="z-40 fixed bg-transparent bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 
    ...
    >
      <nav className="flex flex-row items-center w-full justify-between gap-10">
        <img
          src={Logo_NK}
          alt="logo exata"
          className="flex items-center w-fit-content h-[2em] cursor-pointer"
        />
        <ul className="flex flex-row items-center gap-10 max-lg:hidden">
          <li>
            <button
              className="font-thin text-md tracking-wide relative after:absolute after:bottom-0 after:left-0 after:h-[3px] bg-transparent after:w-full after:origin-bottom-right after:scale-x-0  
