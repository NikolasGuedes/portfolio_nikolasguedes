...
function HeaderPage() {
  return (
    <div className="z-50 fixed bg-black w-full border-b-2 border-white px-20 max-lg:px-8 max-h-[8%] min-h-[8%]  3xl:container 3xl:mx-auto py-2 flex justify-center">
      ...
      <img
        ...
        <ul className="flex flex-row items-center gap-10 max-lg:hidden">
          <li>
            <button
              className="font-thin text-xl tracking-wide relative after:absolute after:bottom-0 after:left-0 after:h-[7px] after:w-full after:origin-bottom-right after:scale-x-0  
