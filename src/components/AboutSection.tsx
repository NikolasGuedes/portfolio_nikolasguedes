      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-evenly h-full w-full">
          <img
            src={Foto_Perfil}
            alt="Foto Perfil"
            className="w-36 h-36 md:w-40 md:h-40 rounded-full border-2 border-white object-cover"
          />
          <p className="px-4 py-2 border border-white bg-white text-black rounded-3xl text-sm md:text-base">
            Front-end developer
          </p>
