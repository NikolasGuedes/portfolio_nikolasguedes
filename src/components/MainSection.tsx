  ...
  return (
    <section className="bg-[var(--Cinzabase)] w-full h-screen container mx-auto px-0 py-36">
      <div className="-z-10 absolute top-0 left-0 w-full h-full">
        <img src={Elipse_01} alt="Elipse 01" className="fixed -top-96 -left-64 w-[1200px] h-[1200px]" />
        <img src={Elipse_02} alt="Elipse 02" className="fixed -bottom-96 -right-60 w-[1200px] h-[1200px]" />
      </div>
